...
const Banner: React.FC = () => {
  ...
  return (
    ...
    >
      {/* Gradient overlay — generator ramp (steps 3 / 6 / 9 → brand-75 / 300 / 600) */}
        ...
        <>
          <div
            style={{
              ...
              inset: 0,
              background:
                'linear-gradient(90deg, var(--K15t-color-brand-75) 0%, var(--K15t-color-brand-300) 51.3%, var(--K15t-color-brand-600) 100%)',
              opacity: 0.8,
            }}
          />
