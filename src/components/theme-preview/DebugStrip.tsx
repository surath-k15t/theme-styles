...
/** Resolves a --K15t-line-height-* CSS var reference to its numeric value */
const lhNum = (token: string): string => {
  const map: Record<string, string> = {
    'var(--K15t-line-height-x-small)': '1.1',
    'var(--K15t-line-height-small)': '1.3',
    'var(--K15t-line-height-medium)': '1.5',
    'var(--K15t-line-height-large)': '1.7',
    'var(--K15t-line-height-x-large)': '1.9',
  };
