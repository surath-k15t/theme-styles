  ...
  return (
    <div
      style={{
        ...
        borderRadius: hasBackground ? 'var(--K15t-radius-small)' : undefined,
        /* Well fill: chromatic step 3 — not `--K15t-color-brand-75` so Subtle usage does not gray it out. */
        ...
        {config.apps.map(app => (
          ...
          >
            ...
            <div style={{ alignSelf: hasImageList && isListStyle ? 'center' : undefined }}>
              <div
                style={{
                  fontFamily: s.h3FontFamily ?? 'var(--K15t-font-family-headline)',
